...
function WhereProViewModel(){
    ...
    self.goToEditFanpageN = function(pg){location.hash = "fanpage/" + self.selectedFanpage()+"/"+pg;FB.Canvas.scrollTo(0,0);};
    self.goToEditFanpage = function(){location.hash = "fanpage/" + self.selectedFanpage();}
...
//----------------------------------------
    self.setBusinessHours = function(){
        ...
        businessHours =   $("#businessHours").businessHours({
            ...
            dayTmpl:'<div class="dayContainer" style="width: 50px;">' +
    ...
    routerApp = Sammy(function(){
        ...
        this.get('#selectFanpage', function () {
            FB.api('/me/accounts', function(response) {
                ...
                var mappedPages = $.map(response['data'], function(item) { return new ListItem(item) });
        ...
        switch (x) {
            ...
            case 'hours':
                ...
                for (key in data.hours) {
                    this.hours += ((this.hours != '') ? ',' : '') + key + '=' + data.hours[key];
                }
                break;
            case 'emails':
